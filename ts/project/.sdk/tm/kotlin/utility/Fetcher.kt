...
private fun clientFor(fetchdef: MutableMap<String, Any?>): HttpClient {
  ...
  val praw = fetchdef["proxy"]
  val proxy = if (praw is String) praw else ""

  return clients.computeIfAbsent("$redirectPolicy|$proxy") {
