...
use crate::utility::voxgigstruct::re::{Captures, Regex, RegexError};

use crate::utility::voxgigstruct::consts::*;
use crate::utility::voxgigstruct::value::{is_integer_f64, js_string, js_to_number, num_to_string, Value};
...
pub fn get_elem(val: &Value, key: &Value, alt: Value) -> Value {
    ...
    match &alt {
        Value::Func(f) => {
            let inj = crate::utility::voxgigstruct::major::Injection::from_def(None);
...
// in-tree pure-Rust Thompson NFA engine (crate::utility::voxgigstruct::re), no third-party crate.
// ---------------------------------------------------------------------------
