// VENDORED: @voxgig/sekreto sdk-20260908-1556-0 (rust/plugins/hashicorp/src/lib.rs)
...
use crate::feature::secrets::sekreto::{checkaddr, providerplugin, vaultref, Answer, AuthSpec, Provider, SekretoError};
