// VENDORED: @voxgig/sekreto sdk-20260907-0029-0 (rust/plugins/azuresecrets/src/lib.rs)
...
use crate::feature::secrets::sekreto::{checkaddr, flatname, providerplugin, Answer, Provider, SekretoError};
use super::httpjson::{
