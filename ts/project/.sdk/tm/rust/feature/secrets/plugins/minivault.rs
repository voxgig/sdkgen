// VENDORED: @voxgig/sekreto sdk-20260917-1242-0 (rust/plugins/minivault/src/lib.rs)
...
//!
//! ```no_run
//! use crate::feature::secrets::sekreto::{Options, ProviderSpec, Sekreto};
...
pub use self::format::{ITERATIONS, MASTERKEY};
