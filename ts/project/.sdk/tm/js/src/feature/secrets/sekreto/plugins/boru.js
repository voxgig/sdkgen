// VENDORED: @voxgig/sekreto sdk-20260908-1556-0 (javascript/plugins/boru.js)
...
const {
  SekretoError, checkname, nodemod, providerplugin,
...
const boru = providerplugin('boru', (spec) =>
  boruprovider({
...
module.exports = { boru, boruprovider }
