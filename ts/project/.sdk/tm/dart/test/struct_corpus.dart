// Vendored from voxgig/struct dart/test/runner.dart.
// Test runner for the shared JSON corpus (../.sdk/test/test.json).
...
// Run the vendored corpus runner over the scaffold's struct group.
// Returns the failure count (failures are also printed).
int structCorpus(String testfile) {
  npass = 0;
  nfail = 0;
  failures.clear();
  ...
  print('struct corpus: PASS $npass  FAIL $nfail');
  return nfail;
}

int structCorpusPassCount() => npass;
