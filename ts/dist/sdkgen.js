...
Object.defineProperty(exports, "resolveAuthIn", { enumerable: true, get: function () { return utility_1.resolveAuthIn; } });
Object.defineProperty(exports, "resolveAuthName", { enumerable: true, get: function () { return utility_1.resolveAuthName; } });
Object.defineProperty(exports, "isAuthSuppressed", { enumerable: true, get: function () { return utility_1.isAuthSuppressed; } });
Object.defineProperty(exports, "isHttpBasicAuth", { enumerable: true, get: function () { return utility_1.isHttpBasicAuth; } });
...
Object.defineProperty(exports, "featureApplies", { enumerable: true, get: function () { return applicability_1.featureApplies; } });
Object.defineProperty(exports, "targetFeatures", { enumerable: true, get: function () { return applicability_1.targetFeatures; } });
Object.defineProperty(exports, "featureTags", { enumerable: true, get: function () { return applicability_1.featureTags; } });
Object.defineProperty(exports, "unknownTags", { enumerable: true, get: function () { return applicability_1.unknownTags; } });
Object.defineProperty(exports, "TAGS", { enumerable: true, get: function () { return applicability_1.TAGS; } });
...
const PublishWorkflow_1 = require("./cmp/PublishWorkflow");
Object.defineProperty(exports, "PublishWorkflow", { enumerable: true, get: function () { return PublishWorkflow_1.PublishWorkflow; } });
const npm_trust_1 = require("./admin/npm-trust");
Object.defineProperty(exports, "npmTrustScript", { enumerable: true, get: function () { return npm_trust_1.npmTrustScript; } });
...
const TestControl_1 = require("./cmp/TestControl");
Object.defineProperty(exports, "TestControl", { enumerable: true, get: function () { return TestControl_1.TestControl; } });
Object.defineProperty(exports, "TEST_CONTROL_EXCLUDE", { enumerable: true, get: function () { return TestControl_1.TEST_CONTROL_EXCLUDE; } });
...
const ReadmeRefFeatures_1 = require("./cmp/ReadmeRefFeatures");
Object.defineProperty(exports, "ReadmeRefFeatures", { enumerable: true, get: function () { return ReadmeRefFeatures_1.ReadmeRefFeatures; } });
...
Object.defineProperty(exports, "entityRelationName", { enumerable: true, get: function () { return buildIdNames_1.entityRelationName; } });
Object.defineProperty(exports, "flowSteps", { enumerable: true, get: function () { return buildIdNames_1.flowSteps; } });
...
const modelNames_1 = require("./helpers/modelNames");
...
Object.defineProperty(exports, "canonScalarKey", { enumerable: true, get: function () { return canonType_1.canonScalarKey; } });
const canonSpec_1 = require("./helpers/canonSpec");
Object.defineProperty(exports, "canonToSpec", { enumerable: true, get: function () { return canonSpec_1.canonToSpec; } });
Object.defineProperty(exports, "entityDataSpec", { enumerable: true, get: function () { return canonSpec_1.entityDataSpec; } });
Object.defineProperty(exports, "entityOpSpec", { enumerable: true, get: function () { return canonSpec_1.entityOpSpec; } });
Object.defineProperty(exports, "entitySpecs", { enumerable: true, get: function () { return canonSpec_1.entitySpecs; } });
const optspec_1 = require("./helpers/optspec");
Object.defineProperty(exports, "optionSpec", { enumerable: true, get: function () { return optspec_1.optionSpec; } });
Object.defineProperty(exports, "featureOptionSpec", { enumerable: true, get: function () { return optspec_1.featureOptionSpec; } });
Object.defineProperty(exports, "entitySpecMap", { enumerable: true, get: function () { return optspec_1.entitySpecMap; } });
...
Object.defineProperty(exports, "ownPoint", { enumerable: true, get: function () { return opShape_1.ownPoint; } });
...
Object.defineProperty(exports, "isRbSdkConstant", { enumerable: true, get: function () { return naming_1.isRbSdkConstant; } });
...
Object.defineProperty(exports, "luaKey", { enumerable: true, get: function () { return naming_1.luaKey; } });
Object.defineProperty(exports, "prefixLeadingDigit", { enumerable: true, get: function () { return naming_1.prefixLeadingDigit; } });
...
Object.defineProperty(exports, "serverVarEnv", { enumerable: true, get: function () { return serverVars_1.serverVarEnv; } });
...
Object.defineProperty(exports, "pointSegments", { enumerable: true, get: function () { return pointPath_1.pointSegments; } });
Object.defineProperty(exports, "pointParts", { enumerable: true, get: function () { return pointPath_1.pointParts; } });
Object.defineProperty(exports, "pointTerminalParam", { enumerable: true, get: function () { return pointPath_1.pointTerminalParam; } });
Object.defineProperty(exports, "pointPathKey", { enumerable: true, get: function () { return pointPath_1.pointPathKey; } });
...
Object.defineProperty(exports, "pluginExcludes", { enumerable: true, get: function () { return featureSource_1.pluginExcludes; } });
Object.defineProperty(exports, "pluginExcludesFor", { enumerable: true, get: function () { return featureSource_1.pluginExcludesFor; } });
...
Object.defineProperty(exports, "originName", { enumerable: true, get: function () { return packageMeta_1.originName; } });
...
function SdkGen(opts) {
    ...
    async function generate(spec) {
        ...
        (0, modelNames_1.guardModelNames)(model, log);
        let Root = spec.root;
        ...
        if (model?.main?.[apidef_1.KIT]?.doc?.active !== false && Object.values(model?.main?.[apidef_1.KIT]?.doc?.edition ?? {})
            ...
            const docgenPath = require.resolve('@voxgig/docgen', {
                paths: [node_path_1.default.join(root, '.sdk')],
            });
    ...
    const edition = {
        add: async (items) => {
            const ctx = resolveActionContext();
            return (0, edition_1.edition_add)(items, ctx);
        }
    };
...
function resolveExternalOverride(opts, log) {
    ...
    try {
        ...
        throw new utility_1.SdkGenError('SDKGEN_EXTERNAL is not valid JSON: ' + (err?.message || err) +
    ...
    if (null == parsed || 'object' !== typeof parsed || Array.isArray(parsed)) {
        throw new utility_1.SdkGenError('SDKGEN_EXTERNAL must be a JSON OBJECT keyed by item name, for example:' +
            '\n    {"seneca-provider":{"path":"../..","sdkrel":".sdksrc/acme-sdk","enclosing":true}}' +
            '\n  Got: ' + raw.slice(0, 200));
    }
...
function externalItems(model, folder, kinds, override) {
    return kinds.flatMap((kind) => {
        const items = model?.main?.[apidef_1.KIT]?.[kind] || {};
...
function checkExternalFolders(external, root, fs) {
    ...
    for (const ext of external) {
        ...
        if (null != claimed[ext.folder]) {
            throw new utility_1.SdkGenError('External output path is already claimed by ' +
                claimed[ext.folder] + '.\n  ' + where +
        ...
        if (!fs.statSync(ext.folder).isDirectory()) {
            throw new utility_1.SdkGenError('External output path is not a folder.\n  ' + where);
        }
...
function withoutExternal(model, external) {
    ...
    return {
        ...model,
        main: { ...model.main, [apidef_1.KIT]: kit },
    };
}
