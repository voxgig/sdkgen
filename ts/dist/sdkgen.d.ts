...
import { packageName, installCommand, pkgDescription, nonAffiliation, keywords, repoInfo, apiName, langLabel, PUBLISHER, PUBLISHER_URL, SECURITY_EMAIL, GENERATOR_URL } from './helpers/packageMeta';
type SdkGenOptions = {
    folder: string;
    fs: any;
    root?: string;
...
export { Main, Deploy, License, Security, Changelog, Entity, Feature, Test, Readme, ReadmeTop, ReadmeInstall, ReadmeQuick, ReadmeIntro, ReadmeModel, ReadmeOptions, ReadmeEntity, ReadmeHowto, ReadmeExplanation, ReadmeRef, FeatureHook, Jostraca, SdkGen, requirePath, isAuthActive, buildIdNames, getMatchEntries, collectDeps, packageName, installCommand, pkgDescription, nonAffiliation, keywords, repoInfo, apiName, langLabel, PUBLISHER, PUBLISHER_URL, SECURITY_EMAIL, GENERATOR_URL, };
