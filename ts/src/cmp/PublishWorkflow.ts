  ...
  Folder({ name: '.github' }, () => {
    Folder({ name: 'workflows' }, () => {
      for (const target of npmTargets) {
        File({ name: workflowFile(target) }, () => {
          Content(publishWorkflow(model, target, npmTargets, repository))
        })
      }
    })
  })
...
function workflowFile(target: any): string {
...
function publishWorkflow(
  model: any, target: any, npmTargets: any[], repository: string | null,
): string {
...
function publishingDoc(model: any, targets: any[], repository: string | null): string {
