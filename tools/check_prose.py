...
# sits under a NOT_DOCS prefix. docs/design/ holds design documents --
# argued, dated, and written for the people changing the generator --
# so it is out.
DOC_GLOBS = ("docs/**/*.md",)
...
WORKING_DOCS = (
    ...
    (r"\bADR\.md\b", "ADR.md"),
    (r"\bNOTES\.md\b", "NOTES.md"),
    (r"\b(?:docs/)?design/[\w.-]+\.md\b", "a design document under docs/design/"),
...
REQUIRED_PAGES = (
    ...
    "docs/explanation/components-and-templates.md",
    ...
    "docs/how-to/author-an-sdkgen-package.md",
    "docs/how-to/customize-and-propagate-templates.md",
    "docs/how-to/debug-generation.md",
    "docs/how-to/migrate-a-bundled-target.md",
    "docs/how-to/release-and-tag.md",
    "docs/how-to/run-a-live-suite.md",
    "docs/how-to/simulate-network.md",
    "docs/how-to/use-an-sdkgen-package.md",
    "docs/how-to/use-station.md",
    "docs/how-to/use-the-api.md",
    ...
    "docs/reference/station-errors.md",
